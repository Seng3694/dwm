...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#1f1626", "#4e2aa2", "#6538cc" },
	[SchemeSel]  = { "#1f1626", "#6538cc", "#6538cc"  },
};
...
static const Key keys[] = {
	...
	{ 0, XK_Print, spawn, SHCMD("maim | xclip -selection clipboard -t image/png -i") },
	{ ShiftMask, XK_Print, spawn, SHCMD("maim -s | xclip -selection clipboard -t image/png -i") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
